...
public class TristaffTest{
	...
	private void init() throws MalformedURLException, JsonProcessingException{
		...
		ApiFindResult kfred = service.find(currentSession, "CorporateUser", 331);
		CorporateUserDto kfredDTO = (CorporateUserDto)kfred.getDto();
		service.save(currentSession, kfredDTO);
